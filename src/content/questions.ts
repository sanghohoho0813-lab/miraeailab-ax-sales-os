...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    why: '반복 입력의 규모는 프로젝트 범위(간단 자동화 vs 부분 AX)를 가르는 기준이다. 반복이 한 군데면 자동화, 여러 업무가 연결돼 있으면 AX 로 간다.',
    options: DEGREE,
  ...
  },
  {
    ...
    why: 'ERP 가 있어도 ERP 밖에서 사람이 반복하는 일을 찾는 것이 AX 다. 기존 시스템을 바꾸자는 제안이 아님을 분명히 하고, 빈틈이 어디인지 파악한다.',
    options: [
      { value: 'none', label: '없음 (엑셀·수기)' },
      { value: 'partial', label: '있지만 밖에서 다시 관리', hint: 'ERP/POS 는 있지만 엑셀·카톡 병행' },
  ...
  },
  {
    ...
    why: '"추가채용 억제" 가치의 근거다. 성장할 때 인건비가 같이 늘어야 하는 구조라면 AX 의 경제가치가 분명해진다. 채용 계획이 있으면 3년 Value Map 의 핵심 입력이 된다.',
    options: [
  ...
  },
  {
    ...
    why: '성장계획이 있어야 AX 가 "비용" 이 아니라 "성장 준비" 로 설명된다. 실증 가능성·자금 설명력(정책금융/R&D/투자)과 연결된다.',
    options: [
  ...
  },
  {
    ...
    why: '서비스·외식·의료는 예약·이탈·재방문이 매출의 본체다. 고객 접점(예약·알림·재방문 제안)이 AX 의 첫 화면이 된다.',
    options: DEGREE,
  ...
  },
  {
    ...
    why: '외식은 POS 가 "얼마 팔았는지" 는 알려주지만 "무엇이 남는지" 는 알려주지 않는다. 데이터 축적과 판단 구조가 AX 의 가치다.',
    options: DEGREE,
    industries: ['food'],
    priority: 3.5,
  },
