...
import { BookOpen, MessageSquare, Settings, ShieldAlert, Inbox, Users, ChevronRight, CalendarClock } from 'lucide-react'
  ...
  const items = [
    ...
    ...(user?.role === 'master'
      ? [
          ...
          { to: '/master/partners', label: '파트너 관리 (마스터)', desc: '파트너 등록·활성화', icon: Users, hue: 'text-accent-600' },
        ]
      : []),
  ]
  return (
